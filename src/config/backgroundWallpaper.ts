...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	common: {
		...
		homeText: {
			...
			switchable: true,
			// 主页横幅主标题
			title: "Well Come To Access NIXXTCØRE!（公测版）",
			// 主页横幅主标题字体大小
			titleSize: "3.8rem",
			// 主页横幅副标题
			subtitle: [
				"我是一位与化学相关的博主",
				"I am a chemistry-focused blogger.",
				"也是一位参与电子音乐创作的音乐人",
				"Also an electronic music producer.",
				"有时负责开发一些Python或C++项目",
				"Occasionally developing Python or C++ projects.",
				"欢迎来到我的个人网站，这里记录了我的创作过程和个人经历",
				"Welcome to my website, documenting my journey through creations and experiences."
			],
