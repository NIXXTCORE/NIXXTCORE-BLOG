...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://nixxtcore.netlify.app",

	// 站点描述
	description:
		"欢迎来到我的个人网站，这里有关于化学、电子音乐创作以及我的个人经历的分享。希望你能在这里找到有价值的内容，并与我一起交流和成长！",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/chem.png",
			alt: "Logo",
		},
		// 导航栏标题
		title: "TEAM NIXXTCØRE & CHEM ⌬",
		// 全宽导航栏，导航栏是否占满屏幕宽度
		widthFull: true,
