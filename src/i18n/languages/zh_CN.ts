...
export const zh_CN: Translation = {
	...
	[Key.searchFriends]: "搜索共创者...",
	[Key.friendsEmpty]: "暂无共创作者",
	[Key.guestbook]: "留言",
	[Key.guestbookDescription]: "欢迎提出有关化学、音乐的想法或对本网站的建议，或者仅仅是打个招呼！😌",
	[Key.untitled]: "无标题",
	...
	// 相册页面
	[Key.gallery]: "动态",
	[Key.galleryDescription]: "这里展示了我的最新动态 ✨",
	[Key.galleryPhotos]: "张动态",
	[Key.galleryAlbums]: "本动态集",
	[Key.galleryNoAlbums]: "暂无动态",
	[Key.galleryBackToAlbums]: "返回动态列表",
	[Key.searchAlbums]: "搜索动态集...",
